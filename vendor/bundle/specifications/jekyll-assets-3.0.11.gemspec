# -*- encoding: utf-8 -*-
# stub: jekyll-assets 3.0.11 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sprockets>.freeze, ["< 4.1.beta", ">= 3.3"])
      s.add_runtime_dependency(%q<liquid-tag-parser>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<jekyll>.freeze, ["< 4.0", ">= 3.5"])
      ...
      s.add_dependency(%q<sprockets>.freeze, ["< 4.1.beta", ">= 3.3"])
      s.add_dependency(%q<liquid-tag-parser>.freeze, ["~> 1.0"])
      s.add_dependency(%q<jekyll>.freeze, ["< 4.0", ">= 3.5"])
